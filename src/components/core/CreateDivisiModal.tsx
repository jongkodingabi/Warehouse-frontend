...
import { Warehouse, Send, X, Group, Clock, Home, Code } from "lucide-react";
...
export default function CreateDivisiModal({
  isOpen,
  onClose,
  onSubmit,
}: {
  ...
  const form = useForm<DivisiFormSchema>({
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="font-semibold text-2xl text-text">Tambah Divisi</h1>
          </div>

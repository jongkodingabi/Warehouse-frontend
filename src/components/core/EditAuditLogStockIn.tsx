...
export default function StockInAuditModal({
  isOpen,
  onClose,
  onSubmit,
  barangData,
  ...
  const handleSubmit = async (values: StockInFormSchema) => {
    ...
    try {
      if (isEditMode && auditData) {
        ...
        await axiosInstance.patch(`/api/v1/auditlog/${barangData.id}`, {
          stock: values.stock,
          deskripsi: values.deskripsi,
          user_id: user?.id,
          type: "Stock In",
          ...
          >
            ...
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="font-semibold text-2xl text-text">
                {isEditMode ? "Edit Stock In" : "Stock In"}
              </h1>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div className="">
                  <span className="text-primary font-medium">Deskripsi:</span>
                  <p className="text-primary font-semibold">
                    {auditData?.deskripsi}
                  </p>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full pl-10 pr-3 py-2.5 bg-background border border-secondary text-text rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all resize-none"
                  />
                </div>
                ...
                >
                  {isLoading ? (
                    <>
                      ...
                      {isEditMode ? "Mengupdate..." : "Menambah Stock..."}
                    </>
                  ) : (
                    <>
                      <Send className="mr-2 w-4 h-4" />
                      {isEditMode ? "Update Stock" : "Tambah Stock"}
                    </>
                  )}
                </button>
              </div>
